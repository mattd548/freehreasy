...
session_start();
 if(!$_SESSION['email']){
  ...
  if(isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO payments_schedule(period, beginning, ending, payCheckDate, periodCompleted) VALUES ('$periodNumber', '$beginning', '$ending', '$payDate', '0')";
    $run_query = mysqli_query($connect,$query);
    header("Refresh:1; payEmp.php");
  }
?>
