...
session_start();
 if(!$_SESSION['email']){
  ...
  if(isset($_POST['submit'])) {
      ...
      $query = "UPDATE benefits SET name = '$benefitName', type = '$benefitType', percentage = '$benefitPercentage' WHERE id = '$benefitID'";
      $run_query = mysqli_query($connect,$query);
    //   header("Refresh:0; deptprofile.php?userId=$userId");
