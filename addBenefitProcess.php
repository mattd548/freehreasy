...
session_start();
 if(!$_SESSION['email']){
  ...
  if(isset($_POST['submit'])) {
    ...
    $benefitPercentage = $_POST['benefitPercentage'];
    
//   $query = "INSERT INTO benefits(id, name, type, percentage) VALUES ('$benefitID', '$benefitName', '$benefitType', '$benefitPercentage')";
   $query = "INSERT INTO benefits(name, type, percentage) VALUES ('$benefitName', '$benefitType', '$benefitPercentage')";
   
   $run_query = mysqli_query($connect,$query);
   header("Refresh:1; benefits.php");
