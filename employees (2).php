...
<body style=" background: url('A_Virus_Named_TOM_Background_Blueprints.jpg'); background-size: cover; background-position: center;">
    ...
    <nav style="font-family: 'Audiowide', cursive;" class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="employees.php">EMPLOYEES<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        ...
        <div style="margin-top:-25px;" class="container">
            <h2 id="innerAdd" class="container"><a href="addEmp.php"><i id="add" class="fas fa-user-plus"></i></a></h2>
        </div>

        <div id="content" class="container">
            <h1 id="header" class="container">Employees</h1>
